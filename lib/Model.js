...
var _enjoiBrowser = require('enjoi-browser');

var _enjoiBrowser2 = _interopRequireDefault(_enjoiBrowser);
 ...
 */
class Model extends _Serializable2.default {
  /**
   *
  ...
  constructor(data = {}, options = {
    defaults: {
      ...
      modified: (0, _utils.unix)(),
      created: (0, _utils.unix)()
    },
    schema: null,
    views: null
  }) {
    ...
    if (options.schema) {
      this[_schema] = (0, _enjoiBrowser2.default)(Object.assign({}, {
        type: 'object',
  ...
  getView(name) {
    ...
    if (view.whitelist) {
      return _lodash2.default.pick(this, view.fields);
    } else {
      return _lodash2.default.omit(this, view.fields);
    }
  }
}
